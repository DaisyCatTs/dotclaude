...
Active memory writing during conversation, plus manual `/memory:consolidate` for real consolidation (not cosmetic tidy). No auto-consolidation.
...
- **Slash command** `/memory:consolidate` — user-invoked only. Fail-closed pipeline:
